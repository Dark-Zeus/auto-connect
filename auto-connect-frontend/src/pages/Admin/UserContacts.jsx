      ...
      <div className="tw:container tw:mx-auto tw:px-4 tw:py-8">
          ...
          <div className="tw:flex tw:flex-col lg:tw:flex-row tw:gap-4 tw:items-center tw:justify-between">
            ...
            <div className="tw:relative tw:w-full lg:tw:w-96">
              ...
              <input
                ...
                className="tw:w-full tw:pl-10 tw:pr-4 tw:py-3 tw:border tw:border-blue-200 tw:rounded-lg tw:focus:ring-2 tw:focus:ring-blue-500 tw:focus:border-blue-500 tw:transition-colors tw:bg-blue-50 tw:text-blue-900"
              />
            </div>
            ...
            <div className="tw:flex tw:flex-wrap tw:gap-3">
              <select
                ...
                className="tw:px-4 tw:py-2 tw:border tw:border-blue-200 tw:rounded-lg tw:focus:ring-2 tw:focus:ring-blue-500 tw:focus:border-blue-500 tw:bg-blue-50 tw:text-blue-900"
              >
        ...
        <div className="tw:grid tw:grid-cols-1 lg:tw:grid-cols-2 xl:tw:grid-cols-3 tw:gap-6">
          {filteredRequests.map((req) => (
            <div
              key={req.id}
              className="tw:bg-gradient-to-br tw:from-white tw:to-blue-50 tw:rounded-2xl tw:shadow-lg tw:border tw:border-blue-100 tw:overflow-hidden tw:hover:shadow-2xl tw:transition-all tw:duration-300 tw:transform tw:hover:-translate-y-1"
            >
              {/* Header */}
              <div className="tw:p-6 tw:pb-4">
                ...
                {/* Message Preview */}
                <p className="tw:text-gray-700 tw:text-base tw:leading-relaxed tw:mb-4 tw:line-clamp-3">
                  {req.message}
                </p>
              ...
              {/* Actions */}
              <div className="tw:bg-blue-50 tw:px-6 tw:py-4 tw:flex tw:justify-between tw:items-center">
                <button
                  onClick={() => setSelectedRequest(req)}
                  className="tw:flex tw:items-center tw:gap-1 tw:text-blue-700 tw:hover:text-blue-900 tw:text-sm tw:font-semibold tw:transition-colors"
                >
        ...
        {selectedRequest && (
          <div className="tw:fixed tw:inset-0 tw:bg-black/40 tw:bg-opacity-50 tw:flex tw:items-center tw:justify-center tw:p-4 tw:z-50">
            <div className="tw:bg-gradient-to-br tw:from-white tw:to-blue-50 tw:rounded-2xl tw:shadow-2xl tw:max-w-2xl tw:w-full tw:max-h-[90vh] tw:overflow-auto tw:border tw:border-blue-100">
              <div className="tw:p-8">
                <div className="tw:flex tw:justify-between tw:items-start tw:mb-8">
                  <div>
                    <h2 className="tw:text-2xl tw:font-extrabold tw:text-blue-900 tw:mb-2">
                  ...
                  <button
                    ...
                    className="tw:text-blue-400 tw:hover:text-blue-600 tw:text-3xl tw:font-bold tw:transition-colors"
                  >
                    ×
                  </button>
                </div>
                ...
                <div className="tw:space-y-6">
                  ...
                  <div className="tw:flex tw:gap-4 tw:pt-4">
                    <button className="tw:flex-1 tw:bg-gradient-to-r tw:from-blue-600 tw:to-blue-700 tw:text-white tw:py-3 tw:px-6 tw:rounded-xl tw:font-semibold tw:shadow-md tw:hover:from-blue-700 tw:hover:to-blue-800 tw:transition-all">
                      <Reply className="tw:w-5 tw:h-5 tw:mr-2 tw:inline" />
                      Reply
                    </button>
                    <button className="tw:px-6 tw:py-3 tw:border tw:border-blue-200 tw:rounded-xl tw:font-semibold tw:text-blue-700 tw:bg-white tw:hover:bg-blue-50 tw:transition-all">
                      <CheckCircle className="tw:w-5 tw:h-5 tw:mr-2 tw:inline" />
                      Mark as Resolved
                    </button>
                  </div>
                </div>
