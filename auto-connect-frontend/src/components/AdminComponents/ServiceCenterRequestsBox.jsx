...
export default function ServiceCenterRequestBox() {
  ...
  return (
    <div className="tw:bg-white tw:rounded-2xl tw:shadow-2xl tw:p-6 tw:border tw:border-blue-200 tw:max-w-8xl tw:w-3xl tw:max-h-[85vh] tw:overflow-y-auto tw:space-y-6">
      ...
      {requests.map((req, index) => (
        <div
          key={index}
          className="tw:bg-blue-50 tw:rounded-xl tw:p-4 tw:border-l-4 tw:border-blue-500 tw:shadow hover:tw:shadow-md tw:transition tw:space-y-3"
        >
