...
function SentNotificationTable({ sentNotifications }) {
  ...
  return (
    <div className="tw:max-w-lg tw:w-full tw:bg-white tw:rounded-xl tw:shadow-md tw:p-6 tw:overflow-x-auto">
      <h2 className="tw:text-xl tw:font-semibold tw:mb-4 tw:text-blue-800">
        Sent Notifications
      </h2>
      ...
      <div className="tw:flex tw:justify-center tw:items-center tw:gap-4 tw:mt-4">
        <button
          ...
          className="tw:px-3 tw:py-1 tw:bg-blue-200 tw:rounded-xl tw:font-semibold tw:text-blue-800 hover:tw:bg-blue-300 disabled:tw:opacity-50"
        >
          Prev
        </button>
