...
function ServiceCenterCard({ name, description, icon, district, rating, onView }) {
  ...
  return (
    <div className="tw:w-full tw:max-w-[308px] tw:h-[220px] tw:bg-white tw:border tw:border-gray-300 tw:rounded-2xl tw:shadow-md tw:transition-all tw:duration-300 hover:tw:shadow-lg tw:p-4 tw:flex tw:flex-col tw:justify-between">
